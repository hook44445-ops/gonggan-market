...
// 앞 10개는 공간, 뒤는 공사 종류(프로필 표시용 · 요청 매칭에는 쓰지 않는다).
export const SPECIALTIES = ["아파트 전체","아파트 부분","원룸/오피스텔","카페/식당","오피스","상가","욕실","주방","바닥/도배","조명/전기",
  "인테리어 필름","타일","페인트","창호/중문","철거","방수/누수","몰딩/도어","줄눈/탄성코트","붙박이장/가구","단열/발코니 확장"];
...
export const CUSTOMER_GRADES = [
  ...
  { id:"홈스타일러",icon:"👑", label:"홈스타일러",minJobs:5, benefits:["VIP 상단 노출","전용 고객 채널"] },
];
