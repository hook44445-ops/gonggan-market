import {
  ...
  Lightbulb, Bell, BellOff, Pencil, Handshake, CalendarClock, Circle, Bookmark, Calendar, BarChart3,
  ...
  Mail, HelpCircle, KeyRound, Package, Image as ImageIcon,
  Upload, Microscope,
