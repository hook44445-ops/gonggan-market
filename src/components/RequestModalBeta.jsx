...
// 소액(도배·부분 수리)도 칩으로 고르게 — 예전엔 최소가 「1,000만원 이하」라 300만원대는 직접 적어야 했다(E2).
const BUDGET_QUICK = ["300만원 이하", "300~500만원", "500~1,000만원", "1,000~3,000만원", "3,000~5,000만원", "5,000만원 이상", "상담 후 결정"];
