    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
          <Icon emoji="🧭" size={15} color="#D6A756" />
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
          ...
          <span style={{ fontSize: 14, fontWeight: 900, color: "#D6A756" }}>+{gainedXp} XP</span>
        </div>
      </div>
      ...
      <div style={{ height: 6, borderRadius: 999, background: "rgba(255,255,255,0.1)", overflow: "hidden", marginBottom: 12 }}>
        <div style={{
          ...
          background: "linear-gradient(90deg,#B98A3A,#D6A756)", transition: "width 0.4s ease",
        }} />
      </div>
          ...
          {tips.map((t) => (
            <div key={t.key} style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
              ...
              <span style={{ fontSize: 12.5, color: "rgba(255,255,255,0.78)", lineHeight: 1.6 }}>
                {t.coach}
                <span style={{ color: "#D6A756", fontWeight: 700 }}>{` (+${t.potentialXp} XP 가능)`}</span>
              </span>
            </div>
          ))}
        </div>
