...
const STAGES = [
  ...
  ["공간보증 업체", "보증금을 건 업체는 300만원 이상 공사에서 결제 직후 자재비 10%를 먼저 받고, 착공 확인 때 20%", "자재비 10%"],
];

// 공사 금액별 지급 구조(서버 escrow_stage_plan · migration 112·120 과 같은 규칙)
const AMOUNT_PLANS = [
  ["500만원 미만", "착공 확인 30% → 완료 확인 70%", "사업자등록을 확인한 업체. 300만원 이상 공사에서 보증금 50만원 이상을 건 업체는 결제 직후 자재비 10%를 먼저 받고 착공 20%"],
      ...
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "22px 20px 40px" }}>
        ...
        <section style={{ marginBottom: 26 }}>
          ...
          <p style={{ fontSize: 12.5, color: "#6b6456", lineHeight: 1.7, margin: "10px 2px 0" }}>
            업체 보증금(공간보증)은 공사 금액 구간 끝의 10% 이상입니다 — 500만원까지 50만원(베이직), 1,000만원까지 100만원(스탠다드),
            2,000만원까지 200만원(프리미엄), 5,000만원까지 500만원(마스터), 1억원까지 1,000만원(시그니처).
            결제 직후 먼저 나가는 자재비 10%는 늘 이 보증금 안에 있습니다.
          </p>
        </section>
