...
function renderLlms(req, res, site) {
  ...
  const lines = [
    ...
    beta
      ...
      : `- 공간안전결제(에스크로)로 시공대금을 예치하고, 단계 확인 후 나눠 지급합니다 — 500만원 미만은 착공 30% · 완료 70%, 500만원 이상은 착공 30%(자재비 포함) · 중간 40% · 완료 30%, 공간보증(보증금) 업체는 300만원 이상 공사에서 결제 직후 자재비 10%를 먼저 받습니다. 1,000만원 초과 공사는 시공보험과 공사 구간 보증금(10% 이상)을 모두 갖춘 업체만 맡습니다.`,
    '',
    '## 시공 업체(공급자)가 받는 것',
